...
class AdaptiveStepsizeODESolver(object):
    ...
    def __init__(self, func, y0, f_options, atol=0.01, rtol=0.001, **unused_kwargs):
...
class FixedGridODESolver(object):
    ...
    def __init__(self, func, y0, f_options, step_size=None, grid_constructor=None, **unused_kwargs):
