...
from .fixed_grid import RK4, Euler, Midpoint
...
def odeint(func, y0, t, rtol=1e-7, atol=1e-9, method=None, options=None, f_options=None):
    ...
    if f_options is None:
        f_options = {}
    solver = SOLVERS[method](func, y0, f_options, rtol=rtol, atol=atol, **options)
