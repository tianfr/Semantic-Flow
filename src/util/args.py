...
def parse_args_from_config(args, conf):
    args.N_samples = conf['N_samples']
    return args, conf
...
def parse_args(
    ...
    parser.add_argument('--i_testset_all',   type=int, default=20000,
                        help='frequency of render_poses video saving')
    parser.add_argument('--N_iters', type=int, default=80001,
    ...
    # parser.add_argument(
    #     '--datadir', '-D', type=str, default='data', help='Dataset directory'
    # )
    # parser.add_argument(
    ...
    #NOTE: for default config code impl. Not use for now.
    ...
    # print('* Dataset location:', args.dataset_file_lists)
    return parse_args_from_config(args, conf)
