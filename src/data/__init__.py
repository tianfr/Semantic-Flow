...
def get_split_dataset(dataset_type, datadir, want_split='train', training=True, file_lists=['data/Balloon2',], use_occlusion=False, **kwargs):
    """
    ...
    if dataset_type == 'srn':
    ...
    elif dataset_type.startswith('monocular'):
        flags['factor'] = 2
        flags['frame2dolly'] = -1
        ...
        flags['use_occlusion'] = use_occlusion
