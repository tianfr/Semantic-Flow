...
def readsemantic(data_dir, idx, time, pose):
    ...
    data_dir = f"{data_dir}/{time}/semantic_labels/{pose}.png"
    img = cv2.imread(data_dir)[...,::-1]
    semantic_true_logit = np.zeros(img.shape[:2])
...
if __name__ == '__main__':
    ...
    # data_dir = '../results'
    data_dir = f'/data/tianfr/NeRF_series/Neural-Scene-Flow-Fields/nsff_exp/logs/500steps_generalization_umbrella_ndc_5f_sv_of_unify3_F00-12'
    print(data_dir)
