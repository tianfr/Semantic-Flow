...
def readimage(data_dir, idx, time, pose):
    ...
    pose = "%02d" % (pose-1)
    idx = "%02d" % idx
    data_dir = f"{data_dir}/{time}/cam{pose}.png"
    img = cv2.imread(data_dir)
    if img is None:
...
if __name__ == '__main__':
    ...
    # data_dir = '../results'
    data_dir = '/data/tianfr/NeRF_series/neuphysics/exp/Truck/neuphysics_default_unseen_frames'
    multiview_dir = os.path.join(data_dir, "validations_all","*")
