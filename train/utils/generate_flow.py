...
if __name__ == '__main__':
    ...
    input_path = os.path.join(args.dataset_path, 'images_2_occlusion')
    output_path = os.path.join(args.dataset_path, 'flow_2_occlusion')
    output_img_path = os.path.join(args.dataset_path, 'flow_png_2_occlusion')
