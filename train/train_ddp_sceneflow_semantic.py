                ...
                if self.conf.get_bool("model.use_semantic_labels", False):
                    ...
                    if self.conf.get_bool("info.use_semantic_consistency", False):
                        ...
                        if img_i < num_img - 1:
                            ...
                            loss += self.conf.get_float('info.semantic_consistency_lambda', 0.04) * loss_dict['semantic_logits_d_f']
                        ...
                        if img_i > 0:
                            ...
                            loss += self.conf.get_float('info.semantic_consistency_lambda', 0.04) * loss_dict['semantic_logits_d_b']
